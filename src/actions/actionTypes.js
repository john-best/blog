...
export const CHECK_EDIT_PRIVS_REQUEST = "CHECK_EDIT_PRIVS_REQUEST";
export const CHECK_EDIT_PRIVS_SUCCESS = "CHECK_EDIT_PRIVS_SUCCESS";
export const CHECK_EDIT_PRIVS_FAILURE = "CHECK_EDIT_PRIVS_FAILURE";
